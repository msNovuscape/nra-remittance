            ...
            <div class="container">
                <div class="grid grid-cols-2 grid-gap-30 article-wrapper">
                    ...
                    <ul class="list-bullet bg-accent text-white">
                        <li>Promoting the legal channel of remittance.</li>
                        <li>Bringing all the stakeholder in a single forum</li>
                        <li>Strenghting the remittance industry contributing in National economy.</li>
                        <li>safeguarding the interest of industry as a whole and remittance company.</li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="grid grid-cols-2 grid-gap-30 article-wrapper bg-light-grey">
                    ...
                    <div class="mission-vision-article bg-accent">
                        <div class="misiosn text-white">
                            ...
                            <p>To faster the development of dynamic, innovative and stable remittance industry that meaningfully contributes to the economic and socual wellbeing of the customers as well as stakeholder and to the socia-economic development of the country.</p>
                        </div>
                        <div class="misiosn text-white">
                            <div class="heading-horizontal">
                                <figure>
                            ...
                            <p>To become a strong association incorporating all the stakeholder and to raise the voice of all the members and to create awareness of the safe, secured and economical way o remitting hard earned money through remittance companies adhering to rules and regulations</p>
                        </div>
                    </div>
                </div>
            </div>
